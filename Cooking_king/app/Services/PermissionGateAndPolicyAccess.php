...
class PermissionGateAndPolicyAccess {
    ...
    {
        Gate::define('menus-list', 'App\Policies\MenuPolicy@view');
        Gate::define('menus-add', 'App\Policies\MenuPolicy@create');
        Gate::define('menus-edit', 'App\Policies\MenuPolicy@update');
        Gate::define('menus-delete', 'App\Policies\MenuPolicy@delete');
